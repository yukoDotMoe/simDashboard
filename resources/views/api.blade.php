...
@section('content')
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"> API Documents <p class="text-xs text-gray-600 dark:text-gray-200">
            Seamlessly integrate sim renting services into your platform.
        </p></h2>
    <a class="flex items-center justify-between p-4 my-6 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple">
