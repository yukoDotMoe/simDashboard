...
@section('content')
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"> Custom Rent </h2>
    ...
    <script>
        $( document ).ready(function() {
            ...
            $('#rentSubmit').click(function () {
                ...
                $.ajax({
                    url: `{{ route('rentFunc') }}?service=${selection}${(network && network !== 'false' && network != null) ? '&network=' + network : ''}`,
                    type: "POST",
                    cache: false,
